...
class Persons(models.Model):
    ...
    # ethnic = models.ForeignKey('Ethnics', on_delete=models.CASCADE)  # 外键
    birthday = models.DateField(max_length=100, verbose_name='生日')  # 生日

    province = models.CharField(max_length=100, verbose_name='省')  # 省
    # province = models.ForeignKey('Provinces', on_delete=models.CASCADE)  # 外键
    city = models.CharField(max_length=100, verbose_name='市')  # 市
    # city = models.ForeignKey('Cities', on_delete=models.CASCADE)  # 外键
